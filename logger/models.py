...
class Torrent(models.Model):
	...
	spidered 	= models.DateTimeField(blank=True, null=True, auto_now_add=True)
...
class Activity(models.Model):
	...
	flags 			= models.CharField(max_length=250, blank=True)
	downloaded 		= models.CharField(max_length=250, blank=True)
